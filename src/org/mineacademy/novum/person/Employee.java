...
import org.mineacademy.novum.person.attributes.Nice;
import org.mineacademy.novum.person.attributes.Rich;
...
public class Employee extends Person implements Nice, Rich {
	...
	public boolean equals(Object obj) {
		return obj instanceof Employee
				&& ((Employee) obj).getPosition().equals(this.position)
				&& ((Employee) obj).getSalary() == this.salary
				&& super.equals(obj);
	}
}
